...
const ParticleSystem = function() {
    ...
    var brush= checkbox.checked;
    var checkbox2 = document.getElementById("velocity");
    var velocity= checkbox2.checked;
    ...
    //create 2d velocity view
    self.createcutvelocity = function(z,b) {
      //color for the pointcloud
        document.querySelectorAll('.cutvelocity').forEach(e => e.remove());
        svg.append("g")
           .attr("transform", "translate(0,0)")
           .call(legend)
           .selectAll("line")
           ...
           .enter()
           .append("line")
           .style("stroke", function(d) {return color(d.concentration);})
           .style("stroke-width", 1.5)
           .attr("x1", function(d) {return xScale(d.X);})
           .attr("y1", function(d) {return yScale(d.Z);})
           .attr("x2", function(d) {return xScale(d.X+d.U*0.5);})
           .attr("y2", function(d) {return yScale(d.Z+d.W*0.5);})
           .attr('class','cutvelocity');
    ...
    rangeslider.oninput = function() {
      ...
      if (velocity) {
          self.createcutvelocity(fixz,bandwidth);
      };
     };
